...
int bag[44] = {100000, 10000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000};
...
long long wandpower[100] = {2000000000000, 500, 1100, 1300, 2400, 5000, 9000, 20000}, wand[100], wandi = 8, wandnamei = 8, wandpoweri = 8;
...
{
   system("cls");
   cout << "店主：这里是巫师们买书的地方，您要买什么？" << endl;
...
int checkpoint(int l)
{
   ...
   {
      a[0] = "#############################";
      a[1] = "#00**009P0000000000000#";
      a[2] = "#09000000000**P000000000#";
      a[3] = "#0000000#0090000o";
      a[4] = "#0*000090#00000#";
      a[5] = "#0000000#000000000000#";
      a[6] = "#T009000##################";
      a[7] = "I00000#================I";
      a[8] = "############T################";
      x = 7;
...
int MM()
{
   if (amm == 0)
   {
      ...
      cout << "攻击即可获得:" << endl;
      cout << "抽奖券100 技能书昏昏倒地或技能书铁甲咒 全幅药水50";
      cout << " 金币2000 经验石X50" << endl;
